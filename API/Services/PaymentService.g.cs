...
namespace Amit.Services
{
    ...
    public interface IPaymentService
    {
        ...
        List<Payment> Get(string filters, string searchTerm, int pageNumber = 1, int pageSize = 0, string sortField = null, string sortOrder = "asc");
    ...
    public class PaymentService : IPaymentService
    {
        ...
        public PaymentService(AmitContext dbContext)
        {
        ...
        public List<Payment> Get(string filters, string searchTerm, int pageNumber, int pageSize, string sortField, string sortOrder)
        {
