...
namespace Amit.Services
{
    ...
    public interface IPaymentGatewayService
    {
        ...
        List<PaymentGateway> Get(string filters, string searchTerm, int pageNumber = 1, int pageSize = 0, string sortField = null, string sortOrder = "asc");
    ...
    public class PaymentGatewayService : IPaymentGatewayService
    {
        ...
        public PaymentGatewayService(AmitContext dbContext)
        {
        ...
        public List<PaymentGateway> Get(string filters, string searchTerm, int pageNumber, int pageSize, string sortField, string sortOrder)
        {
