...
namespace Amit.Services
{
    ...
    public interface IEventService
    {
        ...
        List<Event> Get(string filters, string searchTerm, int pageNumber = 1, int pageSize = 0, string sortField = null, string sortOrder = "asc");
    ...
    public class EventService : IEventService
    {
        ...
        public EventService(AmitContext dbContext)
        {
        ...
        public List<Event> Get(string filters, string searchTerm, int pageNumber, int pageSize, string sortField, string sortOrder)
        {
